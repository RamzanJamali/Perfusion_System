...
void TMC_DRIVER::flow_rate(float flow) {
    runVelocity = flow * 78.5; // The number 78.5 is calculated according to perfusion system parameters. See Formulas.xlsx and Measurements.xlsx for further calculations
