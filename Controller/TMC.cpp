...
void TMC_DRIVER::flow_rate(float flow) {
    runVelocity = flow * 77.15; // The number 77.15 is calculated according to perfusion system parameters. See Formulas.xlsx and Measurements.xlsx for further calculations
